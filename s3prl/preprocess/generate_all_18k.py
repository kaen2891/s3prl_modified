...
def main():
    ...
    #SETS = ['KoSpeech_1000hour', 'command_sentence_adult', 'command_sentence_child', 'command_sentence_elder'] # only use here
    SETS = ['KoSpeech_1000hour', 'NIKL_SEOUL', 'command_sentence_adult', 'command_sentence_elder', 'command_sentence_child', 'free_sentence_adult', 'free_sentence_elder', 'free_sentence_child', 'foreign_sentence'] # only use here
