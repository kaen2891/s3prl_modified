...
def get_preprocess_args():
    ...
    parser.add_argument('-i', '--input_data', default='/Data/junewoo/raw_files/KoSpeech_NIKL/', type=str, help='Path to your LibriSpeech directory', required=False)
...
def main():
    ...
    SETS = ['KoSpeech_1000hour', 'NIKL_SEOUL'] # only use here
