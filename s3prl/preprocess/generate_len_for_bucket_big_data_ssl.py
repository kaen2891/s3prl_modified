...
def get_preprocess_args():
    ...
    parser.add_argument('-i', '--input_data', default='/NasData/home/junewoo/raw_dataset/speech_recognition/korean_speech_dataset/big_data/ssl/', type=str, help='Path to your LibriSpeech directory', required=False)
...
def main():
    ...
    '''
    if 'hun_speech' in args.input_data.lower(): # only use here
        #SETS = ['free_elder_ver2', 'free_adults_ver2', 'free_child_ver2']
        SETS = ['free_sentence_elder', 'free_sentence_adult', 'free_sentence_child', 'foreign_sentence', 'command_sentence_elder', 'command_sentence_adult', 'command_sentence_child']
    else:
