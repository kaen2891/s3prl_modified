...
def get_preprocess_args():
    ...
    parser.add_argument('-i', '--input_data', default='../KoSpeech/', type=str, help='Path to your LibriSpeech directory', required=False)
...
def main():
    ...
    if 'kospeech' in args.input_data.lower(): # only use here
        SETS = ['KoSpeech_1000hour', 'valid_1000hour']
    
    elif 'korean_free_talk_over5' in args.input_data.lower():
        SETS = ['korean_free_talk_adults2_over5', 'korean_free_talk_adults3_over5']
    elif 'korean_over5' in args.input_data.lower():
        SETS = ['korean_free_talk_adults2_over5', 'korean_free_talk_adults3_over5', 'korean_foreign_words2_over5', 'korean_foreign_words3_over5']
    elif 'nikl_over3' in args.input_data.lower():
        SETS = ['NIKL_Seoul_over3']
    else:
